...
folder_dir = "C:/Users/antdu/Mon Drive/projet/data/keypoints_labels"
for file in os.listdir(folder_dir):
    ffile = "C:/Users/antdu/Mon Drive/projet/data/keypoints_labels/" + file
    f1 = open(ffile,'r')
    for line in f1:
